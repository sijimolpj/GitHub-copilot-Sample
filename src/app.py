...
activities = {
    ...
    "Basketball Team": {
        "description": "Team practices and games to improve basketball skills",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["james@mergington.edu", "rachel@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Lap swimming, technique drills, and water safety",
    ...
    "Math Olympiad": {
        "description": "Practice math problems and prepare for academic competitions",
    ...
    "Science Club": {
        ...
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["lucas@mergington.edu", "laura@mergington.edu"]
    }
}
